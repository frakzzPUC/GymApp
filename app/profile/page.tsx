      ...
      try {
        ...
        if (data.success) {
          ...
          setUserData({
            ...
            height: data.user.programData?.height?.toString() || "",
            weight: data.user.programData?.weight?.toString() || "",
            program: data.user.program || "",
            programName: getProgramName(data.user.program),
            goal: data.user.programData?.goal || "",
            goalName: getGoalName(data.user.programData?.goal),
            gender: data.user.programData?.gender || "",
            notifications: {
              email: true,
              push: true,
              sms: false,
